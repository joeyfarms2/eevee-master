function showSearchResult(){
	...
	var full_url = base_url+"admin/news-comment/ajax-get-main-list/"+sid;
	// alert(full_url);
	...
	var search_news_aid = $('#search_news_aid').val();
...
function checkToggleAdvanceSearch(){
	...
	if( search_post_word == "" && created_date_from == "" && created_date_to == "" && search_status_all){
		set_toggle_advance_search('hide');
	}else{

function showSearchResult(){
	...
	var full_url = base_url+"admin/product-category/ajax-get-main-list/"+sid;
	// alert(full_url);
...
function clearSearchResult(){
	...
	$("#search_product_main_all").attr('checked', true);
	$("input[name='search_product_main[]']").each(function()
	{
		this.checked = true;	
	});	
...
function checkToggleAdvanceSearch(){
	...
	var search_product_main_all = $("#search_product_main_all:checked").val();

	if( search_post_word == "" && search_post_word == "" && created_date_from == "" && created_date_to == "" && search_status_all && search_product_main_all){
		set_toggle_advance_search('hide');
	}else{

 ...
 * @document http://image-toolbox.sourceforge.net/docs/li_Image_Toolbox.html
 */
 
// $Id: image_toolbox.class.php,v 1.1 2007/08/02 22:26:58 art Exp $
...
class Image_Toolbox {
	...
	function Image_Toolbox() {
		...
		$gd_support_jpg = isset($gd_info['JPEG Support']) ? $gd_info['JPEG Support'] : $gd_info['JPG Support'];
		if ($gd_support_jpg) {
	...
	function newOutputSize($width, $height, $mode = 0, $autorotate = false, $bgcolor = '#000000') {
		...
		} elseif (($width == 0 && $height > 0) || ($width > 0 && $height == 0)) {
			//keep aspectratio
			if ($autorotate == true) {

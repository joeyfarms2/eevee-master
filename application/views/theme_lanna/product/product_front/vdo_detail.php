				...
				<div class="container">
					...
					<div class="row mb30">
						<div class="col-lg-12"> 
							...
							<?php
								if(is_login() && is_var_array($shelf_vdo_result)){
					...
					<?php if(is_login() && !is_var_array($shelf_vdo_result)){ ?>
						<div class="row mb30">
							<div class="col-lg-12"> 
								<a class="btn btn-md btn-danger" onclick="addToShelfVdo('<?=get_array_value($item_result,"product_type_cid","none");?>','<?=get_array_value($item_result,"aid","0");?>')">
						...
						<?php }else if(!is_login()){ ?>
							<div class="row mb30">
								<div class="col-lg-12"> 
									<a class="btn btn-md btn-default" href="<?=site_url('login')?>">

	...
	<div id="globalWrapper" class="localscroll">
		...
		<section id="content">
			...
			<div class="mt15">
						...
						<div class="container">
							<div class="row">
									<h2 class="subTitle mb15"><a href="<?=site_url('home');?>"><i class="fa fa-home"></i></a><i class="fa fa-angle-right"></i></h2><h2 class="subTitle mb15"><a href="<?=site_url('your-library');?>">MAINMENU</a></h2><h2 class="subTitle mb15"><i class="fa fa-angle-right"></i></h2><h2 class="subTitleRadius mb15">MyShelf</h2>
							</div>     
						</div>
					...
					<div class="container">
						<div class="row">
							...
							<div class=" col-xs-6 sort-by-menu pl0">
								&nbsp;
							</div>
							<?php }else{ ?>
							<div class=" col-xs-3 sort-by-menu pl0">
								<?php 
									$sort_by = @$sort_by; 
							...
							<div class=" col-xs-3 view-by-menu pr0">
								<?php 
									$sort_by = @$sort_by; 
									$show_option = @$show_option;
									$url = 'my-bookshelf';
							...
							<div class=" col-xs-6 sort-by-menu pl0 a-right">
								<!-- <div class="tab-menu < ?=($thisFrontSubMenu=='my_transaction') ? "active" : "";?>"><a href="< ?=site_url('my-transaction-list')?>">Book &amp; Magazine &amp; Media</a></div> -->
								<div class="tab-menu <?=($thisFrontSubMenu=='my_bookshelf') ? "active" : "";?>"><a href="<?=site_url('my-bookshelf')?>">E-Book &amp; E-Magazine</a></div>
							</div>

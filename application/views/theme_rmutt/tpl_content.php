					...
					<div class="container">
						<div class="row">
							<?php if($this_product_main_name == "Knowledge Resources"){?>
								<div class=" col-xs pl0">
							<?php }else{?>
								<div class=" col-xs-7 pl0">
							<?php } ?>
								<h2 class="subTitle mb15"><a href="<?=site_url('home');?>"><i class="fa fa-home"></i></a><i class="fa fa-angle-right"></i></h2><h2 class="subTitle mb15"><a href="<?=site_url('your-library');?>">MAINMENU</a></h2><h2 class="subTitle mb15"><i class="fa fa-angle-right"></i></h2><h2 class="subTitleRadius mb15"><?=@$this_product_main_name?></h2>
					
							</div>
			

							<div class=" col-xs-2 view-by-menu pr10 mt10">
								<ul>

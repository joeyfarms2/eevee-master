				...
				<div class="row list-item">
					<article class="clearfix">
						...
						<div class="item">
							...
							<?php } ?>
							<a href="<?=site_url(get_array_value($item,"product_type_cid","none").'/show-product/'.get_array_value($item,"copy_aid",""))?>" target="_blank"><img alt="" src="<?=get_array_value($item,"thumbnail_image","")?>" class="img-responsive" style=""></a>
						</div>
						<div class="item">
...
function draw_item($item, $optional, $show_option, $sort_by){
	...
	if(is_var_array($item)){
		...
		$txt .=	'<ul class=""><li>'.get_array_value($item,"title","N/A") .'</li></ul>';
		$txt .=	'</div>';
		...
		$txt .=	'<img alt="" src="'.get_array_value($item,"thumbnail_image","").'" class="img-responsive" style="">';
		$txt .=	'</div>';

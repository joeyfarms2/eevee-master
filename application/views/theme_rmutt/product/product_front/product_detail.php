					...
					<div class="row mb30">
						...
						<div class="col-sm-12 col-md-8">
							...
							<?php
								...
								if($product_main_url == 'knowledge-resources'){
							?>
							<p class="spaceUp">
						...
						<?php
							if(is_var_array($digital_list) && $product_main_url != 'knowledge-resources' && $product_main_url != 'online-book'){
								$data = $digital_list[0];
								// print_r($data);
						...
						<?php }else if($product_main_url == 'knowledge-resources'){ ?>
						...
						<?php }else if($product_main_url == 'book' || $product_main_url == 'magazine' || $product_main_url == 'media'){
...
<?php if($product_main_url == 'book' || $product_main_url == 'magazine' || $product_main_url == 'media'){

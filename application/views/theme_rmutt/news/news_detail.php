		...
		<?php if(is_var_array($item_detail)) { ?>
			...
			<div class="box-generic box-news new" data-parent-news-aid="<?=get_array_value($item_detail, 'aid')?>">
				...
				<div class="news-content clearfix">
					...
					<div class="media">
				      ...
				      <div class="media-body clearfix">
				        ...
				        <div class="pull-right">
				        	<?php if ( get_array_value($item_detail,"created_by","") == getUserLoginAid($this->user_login_info) ) { ?>
				        		<a href="javascript:void(0);" class="link edit-news" onclick="editMyNews(this);" data-aid="<?=get_array_value($item_detail, 'aid')?>">Edit</a> | 
				        		<a href="javascript:void(0);" class="link text-danger delete-news" onclick="deleteMyNews(this);" data-aid="<?=get_array_value($item_detail, 'aid')?>">Delete</a>
				        	<?php } ?>
				        </div>
				      </div>
				    </div>
					...
					//	}
					//}
			 		//else if ( get_array_value($item_detail,"ref_link2_image_url","") != "" ) { ?>
	 				<!-- 	<div class="text-center clearfix">
	 						<img src='<?=get_array_value($item_detail,"ref_link2_image_url")?>' class="img-responsive" style="margin:auto;"/>
	 					</div> -->
		 			<?php 
		 			//}
					?>

...
<form id="frm_user" name="frm_user" method="POST" action="<?=site_url('admin/user/save')?>" class="cmxform form-horizontal tasi-form">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-md-12 col-lg-8">
							...
							?>
										<label class="radio-inline">
											<input type="radio" name="user_section_aid" id="user_section_aid_<?=get_array_value($m_item,"aid","")?>" value="<?=get_array_value($m_item,"aid","")?>" <?php if($user_section_aid == $m_user_section_aid) echo 'checked="checked"';?> onclick="" /><?=get_array_value($m_item,"name","")?>
										</label>
							<?php } } ?>
						</div>
					</div>

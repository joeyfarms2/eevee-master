...
if($init_adv_search != "clear"){
	...
	$data_search = $dataSearchSession->userdata('productTypeFieldBackDataSearchSession'); 
}
...
$product_type_result = @$product_type_result; 
$product_type_aid = get_array_value($product_type_result,"aid","0");

// print_r($data_search);
?>
<form id="frm_product_type_field" name="frm_product_type_field" method="POST" action="" class="form-horizontal tasi-form">
...
<input type="hidden" id="product_type_aid" name="product_type_aid" value="<?=$product_type_aid?>" />

	<div class="row">
		<div class="col-xs-12 m-bot15">
			<a href="<?=site_url('admin/product-type/show')?>" class="btn btn-danger">
				<i class="fa fa-reply"></i> Back
			</a>&nbsp;
			<a href="<?=site_url('admin/product-type-field/'.$product_type_aid.'/add')?>" class="btn btn-primary">
				...
				<div id="adv-area" class="panel-body" style="display: none;">
					...
					<div class="form-group">
						<div class="col-lg-offset-2 col-lg-8">
							...
							<a class="btn btn-default" onclick="ajaxClearSearchResult('productTypeFieldBackDataSearchSession')" />Clear</a>
						</div>
					</div>
					<!-- End : Button -->
				</div>

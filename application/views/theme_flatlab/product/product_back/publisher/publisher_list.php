...
if($init_adv_search != "clear"){
	...
	$data_search = $dataSearchSession->userdata('productPublisherBackDataSearchSession'); 
}
...
// print_r($data_search);
?>
<form id="frm_publisher" name="frm_publisher" method="POST" action="" class="form-horizontal tasi-form">
...
<input type="hidden" id="search_order_by" name="search_order_by" value="<?=$search_order_by?>" />
	...
	<div class="row">
		<div class="col-xs-12 m-bot15">
			<a href="<?=site_url('admin/publisher/add')?>" class="btn btn-primary">
				...
				<div id="adv-area" class="panel-body" style="display: none;">
					...
					<div class="form-group">
						...
						<div class="col-md-12 col-lg-8">
							...
							<label class="checkbox-inline">
								<input type="checkbox" id="search_in_1" name="search_in[]"  onclick="changeCheckItem('search_in_all','search_in[]',false,true);showSearchResult();" value="name" <?php if(is_in_array("name",$search_in)) echo "checked"; ?> />Publisher name
							</label>
							<label class="checkbox-inline">
								<input type="checkbox" id="search_in_2" name="search_in[]"  onclick="changeCheckItem('search_in_all','search_in[]',false,true);showSearchResult();" value="contact_name" <?php if(is_in_array("contact_name",$search_in)) echo "checked"; ?> />Contact name
							</label>
							<label class="checkbox-inline">
								<input type="checkbox" id="search_in_3" name="search_in[]"  onclick="changeCheckItem('search_in_all','search_in[]',false,true);showSearchResult();" value="contact_number" <?php if(is_in_array("contact_number",$search_in)) echo "checked"; ?> />Contact number
							</label>
							<label class="checkbox-inline">
								<input type="checkbox" id="search_in_4" name="search_in[]"  onclick="changeCheckItem('search_in_all','search_in[]',false,true);showSearchResult();" value="email" <?php if(is_in_array("email",$search_in)) echo "checked"; ?> />Email
							</label>
						</div>
					</div>
					...
					<div class="form-group">
						<div class="col-lg-offset-2 col-lg-8">
							...
							<a class="btn btn-default" onclick="ajaxClearSearchResult('productPublisherBackDataSearchSession')" />Clear</a>
						</div>
					</div>
					<!-- End : Button -->
				</div>

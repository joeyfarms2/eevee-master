...
<script type="text/javascript" src="<?=JS_PATH?><?=folderName?>/others.js"></script>
<script type="text/javascript" src="<?=JS_PATH?><?=folderName?>/others_copy.js"></script>
<form id="frm_product" name="frm_product" method="POST" action="<?=site_url('admin/product/others-copy/save')?>" class="cmxform form-horizontal tasi-form" enctype="multipart/form-data">
		...
		<div class="col-md-12">
				...
				<div class="panel-body">
							...
							<div class="col-md-12 col-lg-8">
								<div class="checkbox">
									<label>
										...
										This others use license from Bookdose
									</label>
								</div>
							</div>
						</div>
					...
					<div class="form-group hide">
						<div class="col-md-12 col-lg-offset-2 col-lg-8">
							<label class="checkbox-inline">
								<input type="checkbox" id="update_copies" name="update_copies" value="1" <?php if(get_array_value($copy_item_detail,"update_copies","") == "1") echo 'checked="checked"';?> />Update all this value to every copies of this others
							</label>
						</div>
					</div>
			...
			<section class="panel">
				...
				<div class="panel-body">
					...
					<a class="btn btn-default" onclick="processRedirect('admin/product-<?=$product_main_url?>/others/edit/<?=$parent_aid?>/copy');" />Cancel</a>
				</div>
				<!-- End : Button -->
			</section>
		</div>

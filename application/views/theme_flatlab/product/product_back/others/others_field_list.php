<script type="text/javascript" src="<?=JS_PATH?><?=folderName?>/others_field.js"></script>
<?php 
$data_search = "";
$init_adv_search = @$init_adv_search;
if($init_adv_search != "clear"){
	$dataSearchSession = new CI_Session();
	$data_search = $dataSearchSession->userdata('productOthersFieldBackDataSearchSession'); 
}
			...
			<section class="panel">
				...
				<div class="panel-body">
					<div class="col-xs-12 no-left-padding">
						<a href="<?=site_url('admin/product-'.$product_main_url.'/others/edit/'.get_array_value($parent_detail,"aid","").'/field/add')?>" class="btn btn-primary">

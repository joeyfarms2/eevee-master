...
<form id="frm_product" name="frm_product" method="POST" action="<?=site_url('admin/product/others/save')?>" class="cmxform form-horizontal tasi-form" enctype="multipart/form-data">
		...
		<div class="col-md-12">
			...
			<section class="panel">
				...
				<div class="panel-body">
					...
					<a class="btn btn-default" onclick="processRedirect('admin/product-<?=$product_main_url?>/others');" />Cancel</a>
				</div>
				<!-- End : Button -->
			</section>
		</div>

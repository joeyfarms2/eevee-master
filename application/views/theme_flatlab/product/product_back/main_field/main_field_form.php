...
<script type="text/javascript" src="<?=JS_PATH?><?=folderName?>/main_field.js"></script>
<form id="frm_product_main_field" name="frm_product_main_field" method="POST" action="<?=site_url('admin/product-main-field/save')?>" class="cmxform form-horizontal tasi-form" enctype="multipart/form-data">
	...
	<input type="hidden" id="product_main_aid" name="product_main_aid" value="<?=get_array_value($product_main_result,"aid","")?>" />
		...
		<div class="col-md-12">
			<section class="panel">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<label class="col-md-12 col-lg-2 control-label" for="description">Help Text</label>
						<div class="col-md-12 col-lg-8 input-group">
							<input class="form-control" type="text" id="description" name="description" class="" value="<?=get_array_value($item_detail,"description","")?>" onkeypress="" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-12 col-lg-8 input-group">
							<div class="">
								<input class="form-control required" type="text" id="tag" name="tag" value="<?=get_array_value($item_detail,"tag","")?>" maxlength="6" />
			...
			<section class="panel">
				<!-- Button -->
				<div class="panel-body">
					<a class="btn btn-primary" onclick="processSubmitOption('frm_product_main_field', '0');" />Save & Close</a>
					<a class="btn btn-default" onclick="processRedirect('admin/product-main-field/<?=get_array_value($product_main_result,"aid","")?>/show');" />Cancel</a>
				</div>
				<!-- End : Button -->
			</section>
		</div>
...
<script type="text/javascript">
	jQuery(document).ready(function($){
		...
		$("#frm_product_main_field").validate({
			rules: {
				name: {
					required: true
				}

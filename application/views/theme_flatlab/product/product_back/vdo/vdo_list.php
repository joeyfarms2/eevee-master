...
if($init_adv_search != "clear"){
	...
	$data_search = $dataSearchSession->userdata('productVdoBackDataSearchSession'); 
}
...
<input type="hidden" id="product_main_aid" name="product_main_aid" value="<?=$product_main_aid?>" />
	...
	<div class="row">
		<div class="col-xs-12 m-bot15">
			<a href="<?=site_url('admin/product-'.$product_main_url.'/vdo/add')?>" class="btn btn-primary">
				...
				<div id="adv-area" class="panel-body" style="display: none;">
					...
					<div class="form-group">
						<div class="col-lg-offset-2 col-lg-8">
							...
							<a class="btn btn-default" onclick="ajaxClearSearchResult('productVdoBackDataSearchSession')" />Clear</a>
						</div>
					</div>
					<!-- End : Button -->
				</div>

		...
		<div class="col-md-12">
			<section class="panel">
				...
				<div class="panel-body">
					...
					<?php
						if($product_main_url != "book" && $product_main_url != "media"){
					?>
					<div class="form-group">
					...
					*/ ?>
					...
					<div class="form-group">
						...
						<div class="col-md-12 col-lg-8">
							...
							<label class="radio-inline">
								<input type="radio" name="digital_file_type" id="digital_file_type_pdf" value="pdf" <?php if($digital_file_type == "pdf") echo 'checked="checked"';?> onclick="check_file_limit();" />PDF
							</label>
							<label class="radio-inline">
								<input type="radio" name="digital_file_type" id="digital_file_type_epub" value="epub" <?php if($digital_file_type == "epub") echo 'checked="checked"';?> onclick="check_file_limit();" />EPUB
							</label>
							<label class="radio-inline">
					...
					<div class="form-group hide" id="file_upload_area">
						...
						?>
						<div class="col-md-12 col-lg-offset-2 col-lg-8 spaceUp">
								File for app : <?=basename($filename)?> | Size : <?php $file_size = filesize($filename); $file_size_txt = round($file_size/1000); if($file_size_txt > 1000){ echo "<span style='color:#FF0000;'>".$file_size_txt."</span>";}else{echo "<span>".$file_size_txt."</span>";}  ?> kB<BR> 
						</div>
						<?php } } ?>
				...
				<div class="panel-body">
					...
					<div class="form-group hide">
						...
						<div class="col-md-12 col-lg-8">
							...
							<label class="radio-inline">
								<input type="radio" name="type_minor" id="type_minor_5" value="5" <?php if($type_minor == "5") echo 'checked="checked"';?> />Online Book
							</label>
							<label class="radio-inline">
					...
					<?php if($product_main_url != "online-book"){  ?>
					<div class="hide">

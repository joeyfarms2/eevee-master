...
<?php if(is_var_array($parent_detail)){ ?>
	<header class="panel-heading no-radius tab-bg-dark-navy-blue">
		<ul class="nav nav-tabs">
			...
			<?php }else{ ?>
				<li>
					<a href="<?=site_url('admin/product-'.$product_main_url.'/etc/edit/'.get_array_value($parent_detail,"aid",""))?>">
						<i class="fa fa-info"></i>
						General Info
					</a>
				</li>
			...
			<?php }else{ ?>
				<li class=>
					<a href="<?=site_url('admin/product-'.$product_main_url.'/etc/edit/'.get_array_value($parent_detail,"aid","").'/field')?>">
						<i class="fa fa-etc"></i>
						MARC
					</a>
				</li>
			...
			<?php }else{ ?>
				<li>
					<a href="<?=site_url('admin/product-'.$product_main_url.'/etc/edit/'.get_array_value($parent_detail,"aid","").'/copy')?>">
						<i class="fa fa-copy"></i>
						Copy
					</a>
				</li>

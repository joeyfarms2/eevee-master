...
<form id="frm_product" name="frm_product" method="POST" action="<?=site_url('admin/product/magazine-field/save')?>" class="cmxform form-horizontal tasi-form">
		...
		<div class="col-md-12">
			...
			<section class="panel">
				...
				<div class="panel-body">
					...
					<a class="btn btn-default" onclick="processRedirect('admin/product-<?=$product_main_url?>/magazine/edit/<?=$parent_aid?>/field');" />Cancel</a>
				</div>
				<!-- End : Button -->
			</section>
		</div>

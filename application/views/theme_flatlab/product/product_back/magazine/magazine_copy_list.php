...
if($init_adv_search != "clear"){
	...
	$data_search = $dataSearchSession->userdata('productMagazineCopyBackDataSearchSession'); 
}
			...
			<section class="panel">
				...
				<div class="panel-body">
					<div class="col-xs-12 no-left-padding">
						<a href="<?=site_url('admin/product-'.$product_main_url.'/magazine/edit/'.get_array_value($parent_detail,"aid","").'/copy/add')?>" class="btn btn-primary">

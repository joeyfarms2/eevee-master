<script type="text/javascript" src="<?=JS_PATH?>report/access_product/access_product_log.js"></script>
<?php 
...
$product_main_url = get_array_value($data_search,"product_main_url","");
...
<form id="frm_report" name="frm_report" method="POST" action="" class="form-horizontal tasi-form">
	...
	<input type="hidden" id="product_main_url" name="product_main_url" value="<?=$product_main_url?>" />
					...
					<div class="form-group">
						...
						<div class="col-md-12 col-lg-8">
							<div class="input-group date form_datetime-adv" data-date="">
								...
								<input class="form-control" type="text" id="updated_date_from" name="updated_date_from" value="<?=get_array_value($data_search,"updated_date_from","")?>" onchange="showSearchResult();" />

								<span class="input-group-addon">To</span>
								<input class="form-control" type="text" id="updated_date_to" name="updated_date_to" value="<?=get_array_value($data_search,"updated_date_to","")?>" onchange="showSearchResult();" />

								<div class="input-group-btn">
									<button class="btn btn-danger" type="button" onclick="clearValue('updated_date_from');clearValue('updated_date_to');showSearchResult();">
...
$(document).ready(function() {
	...
	$("#updated_date_from, #updated_date_to").datepicker({
		format: "yyyy-mm-dd",
		todayBtn: true,
		todayHighlight: true,
		autoclose: true

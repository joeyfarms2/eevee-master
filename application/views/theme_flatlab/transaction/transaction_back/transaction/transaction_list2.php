				...
				<div id="adv-area" class="panel-body" style="display: none;">
					...
					<div class="form-group">
						...
						<div class="col-md-12 col-lg-8">
							...
							<label class="checkbox-inline">
								<input type="checkbox" id="search_in_1" name="search_in[]"  onclick="changeCheckItem('search_in_all','search_in[]',false,true);showSearchResult();" value="user.contact_number" <?php if(is_in_array("user.contact_number",$search_in)) echo "checked"; ?> />User Contact Number
							</label>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-12 col-lg-8">
							<label class="radio-inline">
								<input type="radio" id="search_option_0" name="search_option" onclick="showSearchResult();" value="0" checked />All
							</label>
							<label class="radio-inline">
								<input type="radio" id="search_option_1" name="search_option"  onclick="showSearchResult();" value="1" <?php if($search_option == "1") echo "checked"; ?> />รายการที่คืนแล้ว
							</label>
							<label class="radio-inline">
								<input type="radio" id="search_option_2" name="search_option"  onclick="showSearchResult();" value="2" <?php if($search_option == "2") echo "checked"; ?> />รายการที่ยังไม่คืน
							</label>
							<label class="radio-inline">
								<input type="radio" id="search_option_3" name="search_option"  onclick="showSearchResult();" value="3" <?php if($search_option == "3") echo "checked"; ?> />รายการที่ยังไม่คืน (ยังไม่เกินกำหนด)
							</label>
							<label class="radio-inline">

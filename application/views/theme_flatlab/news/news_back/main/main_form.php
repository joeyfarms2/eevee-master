...
<form id="frm_news_main" name="frm_news_main" method="POST" action="<?=site_url('admin/news-main/save')?>" class="cmxform form-horizontal tasi-form">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<section class="panel">
				<!-- Button -->
				<div class="panel-body">
					<a class="btn btn-primary" onclick="processSubmitOption('frm_news_main', '0');" />Save & Close</a>
					<a class="btn btn-default" onclick="processRedirect('admin/news-main/show');" />Cancel</a>
				</div>
				<!-- End : Button -->
			</section>
		</div>

...
if($init_adv_search != "clear"){
	...
	$data_search = $dataSearchSession->userdata('newsCategoryBackDataSearchSession'); 
}
...
$search_news_main = get_array_value($data_search,"search_news_main","");
...
<input type="hidden" id="search_order_by" name="search_order_by" value="<?=$search_order_by?>" />
	<div class="row">
		<div class="col-xs-12 m-bot15">
			<a href="<?=site_url('admin/news-category/add')?>" class="btn btn-primary">
			...
			<section class="panel">
				...
				<div id="adv-area" class="panel-body" style="display: none;">
					...
					<div class="form-group <?=(is_root_admin_or_higher() ? '' : 'hidden')?>">
						<label class="col-md-12 col-lg-2 control-label">News main</label>
						<div class="col-md-12 col-lg-8">
							<label class="checkbox-inline">
					...
					<div class="form-group">
						<div class="col-lg-offset-2 col-lg-8">
							...
							<a class="btn btn-default" onclick="ajaxClearSearchResult('newsCategoryBackDataSearchSession')" />Clear</a>
						</div>
					</div>
					<!-- End : Button -->
				</div>

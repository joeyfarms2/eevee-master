...
<form id="frm_ptint" name="frm_ptint" method="POST" action="<?=site_url('admin/print/print-pdf-next')?>" class="cmxform form-horizontal tasi-form" target="_blank">
		...
		<div class="col-md-12">
			<section class="panel">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<label class="col-md-12 col-lg-2 control-label" for="product_main_aid">อักขระนำหน้า Barcode</label>
						<div class="col-md-12 col-lg-8">
							<input class="form-control" name="product_main_aid" type="text" id="prefix" name="prefix"  />
						</div>
					</div>
                   ...
                   <!--  <div class="form-group">
                        <label class="col-md-12 col-lg-2 control-label">เลือกรูปแบบ <br/> Print Barcode</label>
                          	<div class="col-md-12 col-lg-8" style="margin-top:8px;">
                           		<label class="radio-inline">
                           			<input type="radio" name="choose" id="choose" value="1" checked="checked" onclick="document.getElementById('types2').style.display='block';document.getElementById('types1').style.display='none';"  />จาก 000001 ถึง 000999
                           		</label>
                           		<label class="radio-inline">
                           			<input type="radio" name="choose" id="choose" value="2" onclick="document.getElementById('types1').style.display='block';document.getElementById('types2').style.display='none';"/>000111 และ 000222 และ 000333 
                           		</label>
                          </div>
                    </div> -->
						...
						<div class="form-group" id="types2">
							...
							<div class="col-md-12 col-lg-8">
								<div class="input-group">
									...
									<input class="form-control" type="text" id="range_from" name="range_from" placeholder="ระบุให้อยู่ในรูปแบบ 000001" />

									<span class="input-group-addon">To</span>
									<input class="form-control" type="text" id="range_to" name="range_to" placeholder="ระบุให้อยู่ในรูปแบบ 000999" />
						...
						<div class="form-group" id="types1" style="display:none;">
							...
							<div class="col-md-12 col-lg-8">
								<div class="input-group">
									...
									<input class="form-control" type="text" id="range1" name="range1" placeholder="ระบุให้อยู่ในรูปแบบ 000111" />
									<span class="input-group-addon">,</span>
									<input class="form-control" type="text" id="range2" name="range2" placeholder="ระบุให้อยู่ในรูปแบบ 000222" />
									<span class="input-group-addon">,</span>
									<input class="form-control" type="text" id="range3" name="range3" placeholder="ระบุให้อยู่ในรูปแบบ 000333" />

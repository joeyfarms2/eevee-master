						...
						<div class="form-group" id="types1" style="display:none;">
							...
							<div class="col-md-12 col-lg-8">
								<div class="input-group">
									...
									<input class="form-control" type="text" id="range1" name="range[0]" placeholder="ระบุให้อยู่ในรูปแบบ B000111" />
									<span class="input-group-addon">,</span>
									<input class="form-control" type="text" id="range2" name="range[1]" placeholder="ระบุให้อยู่ในรูปแบบ B000222" />
									<span class="input-group-addon">,</span>
									<input class="form-control" type="text" id="range3" name="range[2]" placeholder="ระบุให้อยู่ในรูปแบบ B000333" />
									
								</div>
                                                            <div class="input-group">
									
									<input class="form-control" type="text" id="range1" name="range[3]" placeholder="ระบุให้อยู่ในรูปแบบ B000114" />
									<span class="input-group-addon">,</span>
									<input class="form-control" type="text" id="range2" name="range[4]" placeholder="ระบุให้อยู่ในรูปแบบ B000225" />
									<span class="input-group-addon">,</span>
									<input class="form-control" type="text" id="range3" name="range[5]" placeholder="ระบุให้อยู่ในรูปแบบ B000336" />
									
								</div>
                                                            <div class="input-group">
									
									<input class="form-control" type="text" id="range1" name="range[6]" placeholder="ระบุให้อยู่ในรูปแบบ B000117" />
									<span class="input-group-addon">,</span>
									<input class="form-control" type="text" id="range2" name="range[7]" placeholder="ระบุให้อยู่ในรูปแบบ B000228" />
									<span class="input-group-addon">,</span>
									<input class="form-control" type="text" id="range3" name="range[8]" placeholder="ระบุให้อยู่ในรูปแบบ B000339" />
									
								</div>
                                                            <div class="input-group">
									
									<input class="form-control" type="text" id="range1" name="range[9]" placeholder="ระบุให้อยู่ในรูปแบบ B000801" />
									<span class="input-group-addon">,</span>
									<input class="form-control" type="text" id="range2" name="range[10]" placeholder="ระบุให้อยู่ในรูปแบบ B000222" />
									<span class="input-group-addon">,</span>
									<input class="form-control" type="text" id="range3" name="range[11]" placeholder="ระบุให้อยู่ในรูปแบบ B000333" />
									
								</div>
                                                            <div class="input-group">
									
									<input class="form-control" type="text" id="range1" name="range[12]" placeholder="ระบุให้อยู่ในรูปแบบ B000199" />
									<span class="input-group-addon">,</span>
									<input class="form-control" type="text" id="range2" name="range[13]" placeholder="ระบุให้อยู่ในรูปแบบ B000277" />
									<span class="input-group-addon">,</span>
									<input class="form-control" type="text" id="range3" name="range[14]" placeholder="ระบุให้อยู่ในรูปแบบ B000333" />
									
								</div>
                                                            <div class="input-group">
									
									<input class="form-control" type="text" id="range1" name="range[15]" placeholder="ระบุให้อยู่ในรูปแบบ B000111" />
									<span class="input-group-addon">,</span>
									<input class="form-control" type="text" id="range2" name="range[16]" placeholder="ระบุให้อยู่ในรูปแบบ B000222" />
									<span class="input-group-addon">,</span>
									<input class="form-control" type="text" id="range3" name="range[17]" placeholder="ระบุให้อยู่ในรูปแบบ B000333" />
									
								</div>
                                                            <div class="input-group">
									
									<input class="form-control" type="text" id="range1" name="range[18]" placeholder="ระบุให้อยู่ในรูปแบบ B000444" />
									<span class="input-group-addon">,</span>
									<input class="form-control" type="text" id="range2" name="range[19]" placeholder="ระบุให้อยู่ในรูปแบบ B000555" />
									<span class="input-group-addon">,</span>
									<input class="form-control" type="text" id="range3" name="range[20]" placeholder="ระบุให้อยู่ในรูปแบบ B000666" />
									
								</div>
                                                            <div class="input-group">
									
									<input class="form-control" type="text" id="range1" name="range[21]" placeholder="ระบุให้อยู่ในรูปแบบ B000199" />
									<span class="input-group-addon">,</span>
									<input class="form-control" type="text" id="range2" name="range[22]" placeholder="ระบุให้อยู่ในรูปแบบ B000288" />
									<span class="input-group-addon">,</span>
									<input class="form-control" type="text" id="range3" name="range[23]" placeholder="ระบุให้อยู่ในรูปแบบ B000377" />
									
								</div>
                                                            <div class="input-group">
									
									<input class="form-control" type="text" id="range1" name="range[24]" placeholder="ระบุให้อยู่ในรูปแบบ B012345" />
									<span class="input-group-addon">,</span>
									<input class="form-control" type="text" id="range2" name="range[25]" placeholder="ระบุให้อยู่ในรูปแบบ B023456" />
									<span class="input-group-addon">,</span>
									<input class="form-control" type="text" id="range3" name="range[26]" placeholder="ระบุให้อยู่ในรูปแบบ B002356" />

...
// if($init_adv_search != "clear"){
    ...
    $data_search = $dataSearchSession->userdata('TopBorrowBackDataSearchSession'); 
// }
...
<span style=" font-size:22px;">Top Borrowers</span><br /><br />
<div class="row">
    <div class="col-xs-12">
        <div class="row">
            <div class="col-xs-12">
                        ...
                        <tbody>
                            ...
                            if(is_var_array($result_list)){
                                ...
                                <tr role="row"  bgcolor="<?= $class ?>">
                                    ...
                                    <td class="hidden-xs hidden-sm hidden-md w100 a-center " ><?=get_array_value($item,"borrowing","")?></td>
                                    <td class="hidden-xs hidden-sm hidden-md w100 a-center " ><?=get_array_value($item,"theCount","")?></td>
                                    <td class="hidden-xs hidden-sm hidden-md w100 a-center " ><?=get_array_value($item,"borrowed","")?></td>
                                    <td class="hidden-xs hidden-sm hidden-md w100 a-center " ><?=get_array_value($item,"returned","")?></td>
                                </tr>
                            <?php 
                                    }
                                }

								...
								<form id="frm_user" name="frm_user" class="form-horizontal tasi-form" method="POST" action="<?=site_url('my-account/save')?>" enctype="multipart/form-data" data-role="validator" novalidate="novalidate">
									...
									?>
										...
										<div class="form-group">  
											...
											<input type="text" class="form-control required email" id="email" name="email" value="<?=get_array_value($item_detail,"email","")?>"   />
										</div>
									...
									if(get_array_value($item_detail,"user_section_aid","") == "3" ){ 
									
									?>
										
										<div class="form-group">                                                  
											<label class="required" for="username">Student ID Number: </label>
											<input type="text" class="form-control required" id="username" name="username" value="<?=get_array_value($item_detail,"username","")?>" readonly/>
										</div>

									
										<div class="form-group">
											<label class="required" for="note_1">Degree:</label>
											<div class="required">
												<?php $note_1 =  get_array_value($item_detail,"note_1",""); ?>
												<select id="note_1" name="note_1" class="form-control required chzn-select" >
													<option value="">Choose publisher..</option>
													
															<option value="1" <?php if("1" == $note_1) echo 'selected="selected"';?>>ป.บัญฑิต</option>
															<option value="2" <?php if("2" == $note_1) echo 'selected="selected"';?>>ปริญญาตรี</option>
															<option value="3" <?php if("3" == $note_1) echo 'selected="selected"';?>>ปริญญาโท</option>
															<option value="4" <?php if("4" == $note_1) echo 'selected="selected"';?>>ปริญญาเอก</option>
									...
									?>
										...
										<?php }if(get_array_value($item_detail,"user_section_aid","") == "3" ){ ?>
											<label class="required" for="department">Faculty</label>
										<?php } ?>
											<div class="required">

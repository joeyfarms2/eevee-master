							...
							<div class="">
								...
								<form id="frm_user" name="frm_user" class="form-horizontal tasi-form" method="POST" action="<?=site_url('registration/save')?>" data-role="validator" novalidate="novalidate"> 
									...
									<!-- <div class="form-group">
											...
											<div class="col-sm-8">
											<input type="text" class="form-control required" id="username" name="username" value="<?=get_array_value($item_detail,"username","")?>" />
											</div>
									</div>
 									...
 									<div class="form-group">
										<label class="control-label col-sm-4 required" for="email">Email</label>
											<div class="col-sm-8 input-group">
												<input type="text" class="required form-control" id="email" name="email" value="<?=get_array_value($item_detail,"email","")?>"/>
											</div>
									</div>

									<?php if(is_specify_password()){ ?>
											<div class="form-group">                                                
												<label class="control-label col-sm-4 required" for="password">Your Password </label>
												<div class="col-sm-8">
											...
											<div class="form-group">                                                
												<label class="control-label col-sm-4 required" for="retype_password">Confirm Password</label>
												<div class="col-sm-8">
										...
										<div class="form-group">
											<label class="control-label col-sm-4 required" for="cid">Citizen ID / Passport ID</label>
											<div class="col-sm-8">
										...
										<div class="form-group">
											<label class="control-label col-sm-4 required" for="first_name_th">First Name</label>
											<div class="col-sm-8">
										...
										<div class="form-group">
											<label class="control-label col-sm-4 required" for="last_name_th">Last Name</label>
											<div class="col-sm-8">
										...
										<div class="form-group ">
											<label class="col-md-12 col-lg-4 control-label required" for="gender">Gender</label>
										...
										<div class="form-group">
											<label class="control-label col-sm-4 required" for="contact_number">Phone</label>
											<div class="col-sm-8">
										...
										<div class="form-group">
											<label class="control-label col-sm-4 required" for="note_2">Company Name</label>
											<div class="col-sm-8">
										...
										<div class="form-group">
											<label class="control-label col-sm-4 required" for="note_3">Company Address</label>
											<div class="col-sm-8">
										...
										<div class="form-group">
											<label class="control-label col-sm-4 required" for="note_4">Company Phone Number</label>
											<div class="col-sm-8">
										...
										<div class="form-group">
											<label class="control-label col-sm-4 required" for="position">Job Position</label>
											<div class="col-sm-8">
										...
										<div class="form-group">                                                
											<label class="control-label col-sm-4 required" for="captcha_code">Captcha</label>
											<div class="col-sm-8">

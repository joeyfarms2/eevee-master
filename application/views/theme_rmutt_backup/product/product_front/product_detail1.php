				...
				<div class="container">
					...
					<div class="row mb30">
						...
						<div class="col-sm-12 col-md-8">
							...
							<p class="spaceUp">
								<?php
									if($product_main_url == 'book' || $product_main_url == 'magazine' || $product_main_url == 'media' || $product_main_url == 'online-book'){
								?>
								<div class="col-xs-5 col-sm-2 col-md-4 col-lg-2 no-left-padding no-right-padding">
									<span class="product-sub-title">Call No.</span>
								</div>
								<div class="col-xs-7 col-sm-10 col-md-8 col-lg-4 no-left-padding no-right-padding">
									: <?=get_array_value($item_result,"call_number","N/A")?>
								</div>
								<?php
									}
								?>
						...
						<?php
							if(is_var_array($digital_list) && $product_main_url != 'data-subscription' && $product_main_url != 'online-book'){
								$data = $digital_list[0];
								// print_r($data);
						...
						<?php }else if($product_main_url == 'online-book'){
						?>
						<div class="col-sm-12 col-md-8 detail-box">
							<p class="spaceUp">
								<div class="">
									
										<a class="btn btn-lg btn-info" href="<?=site_url('show-online-book?type='.$product_type_cid.'&id='.get_array_value($item_result,"aid",""))?>" target="blank">
										&nbsp;&nbsp;&nbsp;Access&nbsp;&nbsp;&nbsp;
										</a>
										&nbsp;&nbsp;&nbsp;
						...
						<?php
						}else if($product_main_url == 'book' || $product_main_url == 'magazine' || $product_main_url == 'media'){
						...
						?>
									<tr class="" height="38px">
										...
										<td class="box_book_padding" width="120px" <?php if(get_array_value($m_item,"shelf_status_name","") == "Borrowed") echo "style='color:red;'";?>><center><?=get_array_value($m_item,"shelf_status_name","");?></center></td>
										<td class="box_book_padding">
										<?php
											if(get_array_value($m_item,"shelf_status_name","") != "Borrowed"){
										?>
											<center>
												<a class="btn btn-success box_book_btn" href="<?=site_url('ask-librarian/book-and-product-inquiry?type='.$product_type_cid.'&id='.get_array_value($item_result,"aid","").'&code='.get_array_value($m_item,"barcode",""))?>">
													&nbsp;Reserve&nbsp;
												</a>
											</center>
										</td>

	...
	<div class="boxFocus ">
		...
		<?php foreach($new_list as $item){ ?>
			<div class="col-md-12 a-center">
				...
				?>
				<a href="<?=site_url(get_array_value($item,"product_type_cid","none").'-detail/'.get_array_value($item,"aid",""))?>"><img src="<?=get_image(get_array_value($item,"cover_image_thumb_path",""), $class."thumb",get_array_value($item,"thumbnail_image",""))?>" alt="<?=removeAllQuote(get_array_value($item,"title",""))?>" class="mb15 img-responsive"></a>
			</div>
		<?php } ?>
	</div>
	<?php } ?>

		...
		<div class="container mt15 <?=$class?>-box">
			<div class="row">
				<div class="col-ms-9">
					...
					?>
						<div class="title-manu-home"><img src="<?=CSS_PATH?><?=CONST_CODENAME?>/images/background/header_book.png"></div>
					<?php
					}
					if(get_array_value($item,"product_main_id","-") == "3") {
					?>
						<div class="title-manu-home"><img src="<?=CSS_PATH?><?=CONST_CODENAME?>/images/background/header_ebook.png"></div>
					<?php
					}
					if(get_array_value($item,"product_main_id","-") == "4") {
					?>
						<div class="title-manu-home"><img src="<?=CSS_PATH?><?=CONST_CODENAME?>/images/background/header_emagazine.png"></div>
					<?php
					}
					if(get_array_value($item,"product_main_id","-") == "5") {
					?>
						<div class="title-manu-home"><img src="<?=CSS_PATH?><?=CONST_CODENAME?>/images/background/header_multimedia.png"></div>
					<?php
					}
					if(get_array_value($item,"product_main_id","-") == "6") {
					?>
						<div class="title-manu-home"><img src="<?=CSS_PATH?><?=CONST_CODENAME?>/images/background/header_information.png"></div>
					<?php
					}
					if(get_array_value($item,"product_main_id","-") == "7") {
					?>
						<div class="title-manu-home"><img src="<?=CSS_PATH?><?=CONST_CODENAME?>/images/background/header_knowledge.png"></div>
					<?php
					}
					if(get_array_value($item,"product_main_id","-") == "8") {
					?>
						<div class="title-manu-home"><img src="<?=CSS_PATH?><?=CONST_CODENAME?>/images/background/header_cddvd.png"></div>
					<?php
					}
					?>
				</div>
				<div class="col-ms-2">
					<a class="custom-home-box-seeall" href="<?=site_url('list-'.get_array_value($item,"product_type_cid","none").'/category/'.get_array_value($item,"product_main_url","none"))?>"><h3>&nbsp;&nbsp;See All</h3></a>
				</div>
			</div>

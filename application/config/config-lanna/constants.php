...
define('CONST_LDAP_LOGIN', '3'); // 0: Login using our system ,1: Login LDAP server, 2: Login LDAP server soap 3: Login LDAP server json
...
/** Editable Zone **/
define('DEFAULT_TITLE', 'ห้องสมุดสื่อทรัพยากรออนไลน์วิทยาลับเทคโนโลยีโปลิเทคนิคลานนา เชียงใหม่'); // This value will show in title bar of web browser
define('META_DESCRIPTION', '"ความรู้คู่คุณธรรม" วิทยาลัยกำหนดปรัชญาการศึกษาโดยมุ่งพัฒนาผู้เรียนให้มีความสามารถทางวิชาการ มีทักษะในการปฏิบัติงาน และมีคุณสมบัติที่จำเป็นตามลักษณะอาชีพ พร้อมที่จะทำงานร่วมกับผู้อื่น หรือทำงานเป็นอิสระ สามารถปรับปรุงตนให้ทันต่อวิวัฒนาการทางเทคโนโลยี มีระเบียบวินัย มีความสำนึกในจรรยาบรรณวิชาชีพ ควบคู่ไปกับคุณธรรมในการดำรงชีวิต มีความรับผิดชอบต่อตนเอง และสังคม');
define('META_KEYWORDS', 'LPS , LPS e-library , Library , Lannapoly , โปลิเทคนิคลานนา');

define('ADMIN_EMAIL', 'noreply@lanna.com'); // This is an email will show in automatic mail sent.
define('ADMIN_EMAIL_NAME', 'ห้องสมุดสื่อทรัพยากรออนไลน์วิทยาลับเทคโนโลยีโปลิเทคนิคลานนา เชียงใหม่'); // This is name will show in automatic mail sent.
define('ADMIN_EMAIL_SIGNATURE', 'ห้องสมุดสื่อทรัพยากรออนไลน์วิทยาลับเทคโนโลยีโปลิเทคนิคลานนา เชียงใหม่'); // This is signature will show in automatic mail sent.

define('CONTACT_EMAIL', 'lanna.library@lanna.com'); // This is an email that user can send feedback or ask for your support.
define('MAIN_CONTACT_EMAIL', 'lanna.library@lanna.com'); // This is an email that user can send feedback or ask for your support

define('CONST_MAIN_DOMAIN_EMAIL', '1');
define('MAIN_DOMAIN_EMAIL', 'lanna.com'); 
define('CONST_FB_LINK', ''); // This is an facebook link
define('WEB_URL', 'http://www.lannapoly.com');
...
define('THEME_FRONT_PATH', PUBLIC_PATH.'styles/lanna/');
define('THEME_ADMIN_PATH', PUBLIC_PATH.'styles/flatlab/');

define('THEME_ADMIN', '_flatlab');
define('THEME_FRONT', '_lanna');
define('THEME_LOGIN', '_lanna');
...
define('CONST_ONLINE_REGIS','0'); // 1:Has online register, 0:DONT have online register, default is 0
...
define('CONST_EVENT_MODE','0'); // 1:Full mode, 2:Simple mode, default is 1

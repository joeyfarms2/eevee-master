...
class Book_field_model extends Product_init_model {
	
	function __construct()
	{
		// Call the Model constructor
        parent::__construct();
		$this->set_table_name("book_field");
...
/* End of file book_field_model.php */
/* Location: ./system/application/model/book_field_model.php */
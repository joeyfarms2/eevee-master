...
class Others_field_model extends Product_init_model {
	
	function __construct()
	{
		// Call the Model constructor
        parent::__construct();
		$this->set_table_name("others_field");
...
/* End of file others_field_model.php */
/* Location: ./system/application/model/others_field_model.php */
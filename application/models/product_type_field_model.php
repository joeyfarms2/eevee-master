<?php
class Product_type_field_model extends Initmodel {
	
	function __construct()
	{
		// Call the Model constructor
        parent::__construct();
		$this->set_table_name("product_type_field");
	}
...
/* End of file product_type_field_model.php */
/* Location: ./system/application/model/product_type_field_model.php */
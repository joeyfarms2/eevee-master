<?php
class News_comment_user_activity_like_model extends Initmodel {
	
	function __construct()
	{
		// Call the Model constructor
        parent::__construct();
			$this->set_table_name("news_comment_user_activity_like");
	...
	function do_like($news_comment_aid){
	...
	function do_unlike($news_comment_aid){
	...
	function has_liked($news_comment_aid){
		$this->set_where(array(
				'news_comment_aid' => $news_comment_aid,
				'user_aid' => getUserLoginAid($this->user_login_info)
			)

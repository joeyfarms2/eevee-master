...
class Magazine_copy_model extends Product_init_model {
	
	function __construct()
	{
		// Call the Model constructor
        parent::__construct();
		$this->set_table_name("magazine_copy");
	...
	function set_join_for_desc($obj=""){
		...
		$this->db->join($this->tbl_magazine_name.' AS parent', $this->get_table_name().'.parent_aid = parent.aid', "left");
...
/* End of file magazine_copy_model.php */
/* Location: ./system/application/model/magazine_copy_model.php */
...
class Others_copy_model extends Product_init_model {
	
	function __construct()
	{
		// Call the Model constructor
        parent::__construct();
		$this->set_table_name("others_copy");

		$this->tbl_others_name = "others";
	...
	function set_join_for_desc($obj=""){
		...
		$this->db->join($this->tbl_others_name.' AS parent', $this->get_table_name().'.parent_aid = parent.aid', "left");
		$this->db->join($this->tbl_product_type_name.' AS product_type', $this->get_table_name().'.product_type_aid = product_type.aid', "left");
	}
	
	function fothersh_data_with_desc($query)
	{
		$result = "";
...
/* End of file others_copy_model.php */
/* Location: ./system/application/model/others_copy_model.php */
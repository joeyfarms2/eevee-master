...
class Book_copy_model extends Product_init_model {
	
	function __construct()
	{
		// Call the Model constructor
        parent::__construct();
		$this->set_table_name("book_copy");

		$this->tbl_book_name = "book";
	...
	function set_join_for_desc($obj=""){
		...
		$this->db->join($this->tbl_book_name.' AS parent', $this->get_table_name().'.parent_aid = parent.aid', "left");
...
/* End of file book_copy_model.php */
/* Location: ./system/application/model/book_copy_model.php */
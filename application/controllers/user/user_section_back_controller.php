...
class User_section_back_controller extends User_init_controller {
	...
	function __construct(){
		...
		define("thisAdminSubMenu",'user_section');
		@define("folderName",'user/user_back/section');
		
		define("TXT_TITLE",'Section management');
		define("TXT_INSERT_TITLE",'Section management : Add new section');
		define("TXT_UPDATE_TITLE",'Section management : Edit section');
				
		$this->main_model = 'User_section_model';
	...
	function show($msg=""){
		...
		$this->data["view_the_content"] = $this->default_theme_admin . '/' . folderName . '/section_list';
	...
	function form(){
		$this->data["title"] = DEFAULT_TITLE;
		$this->data["view_the_content"] = $this->default_theme_admin . '/' . folderName . '/section_form';
		$this->load->view($this->default_theme_admin.'/tpl_admin',$this->data);
	}

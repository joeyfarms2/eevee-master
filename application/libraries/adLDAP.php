...
class adLDAP {
    ...
    * @var string
    */   
	protected $_account_suffix = "@rmutt.ac.th";
    ...
    * @var string
    */
	protected $_base_dn = "DC=rmutt,DC=ac,DC=th"; 
    ...
    * @var array
    */
    protected $_domain_controllers = array ("203.158.253.46");
    ...
    * @return void
    */
    //Edit by bank, passw have quote complete
	public function set_ad_password($_ad_password)
    {
          $this->_ad_password = stripslashes($_ad_password);
    }
